...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://palmenderi:Password1234@meetupcluster.bgzbi1o.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
...
async function getStaticProps(context) {
    ...
    const db = client.db();
    const meetupsCollection = db.collection("meetups");
    const meetupIdObject = new external_mongodb_.ObjectId(meetupId);
